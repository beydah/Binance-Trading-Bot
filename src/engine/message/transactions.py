...
MAIN_TRANSACTIONS = ["ANALYSIS_COIN_LIST", "ANALYSIS_WALLET", "WRITE_COIN_LIST",
...
def TRANSACTION(USERNAME, PROMPT):
    if not WRITE_MODE[0]:
        if PROMPT == "START": MESSAGE.SEND(f"Hello {USERNAME}! I am Binance Trading Bot. You can do Coin "
                                   f"analysis, Coin backtest and automatic buy and sell transactions with me.\nMore: "
                                   f"'/info'\n")
        elif PROMPT == "INFO": MESSAGE.SEND("Transactions:\n\nAnalysis Coin List\nWrite Coin List\nInsert Coin List\nDrop "
                                    "Coin List\n\nAnalysis Wallet\nGet Wallet\n\nAnalysis Coin\nBacktest Coin\n\nOpen "
                                    "Trade\nClose Trade\n\nMore: '/help'\n")
        elif PROMPT == "HELP": MESSAGE.SEND("Tutorial:\n\nAnalysis Coin List: It finds and sorts the min/max rising ones of "
                                    "the coin list you have already written and gives you a favorite/warning list. In "
                                    "order for this code to work, a Coin List must be written.\n\nWrite Coin List: It "
                                    "takes the coin symbols you have written below and creates a list of "
                                    "them.\nExample:\nMessage 1: 'Write Coin List'\nMessage 2:\n          BTC\n       "
                                    "   BNB\n          SOL\n          XEC\n          ...\n\nInsert Coin List: You can "
                                    "see your Coin List and add to the list.\n\nDrop Coin List: You can see your Coin "
                                    "List and delete it from the list.\n\n\nAnalysis Wallet: Allows you to view your "
                                    "wallet's changes from yesterday to today and your total/spot/earn "
                                    "balance.\n\nGet Wallet: Lists all balances in your wallet.\n\n\nAnalysis Coin: "
                                    "It shares with you the indicator results and change percentage of the coin you "
                                    "typed.\n\nBacktest Coin: It shares with you all the buying and selling results "
                                    "of the coin you typed.\n\n\nOpen Trade: Initiates buy and sell transactions and "
                                    "buys at suitable opportunities.\n\nClose Trade: Performs sell transaction and "
                                    "transfers to cash\n\n\nMore: '/trade'\n")
        elif PROMPT == "TRADE": MESSAGE.SEND("All rights of the code belong to Ilkay Beydah Saglam.\n\nThe code's sell "
                                     "strategy creates a new sell signal by interpreting the satellite signals coming "
                                     "from EMA, SMA, Golden Cross, RSI, StochRSI values and trades according to this "
                                     "signal. You can backtest some of your wealth symbols before using this "
                                     "strategy.\n\nIf you want the code to buy and sell, you must go to the "
                                     "src/settings/ parts in the application system and enter the Binance token and "
                                     "Binance confidential information in the /api.py data there. These values are "
                                     "provided by Binance and these values must have Read permission and Spot / "
                                     "Margin sales permission.\n\nMany operations in the code are performed or "
                                     "facilitated via telegram. To perform these operations, you must create a bot "
                                     "with Bot Father on Telegram, go to the src/settings/ computer in the "
                                     "application system and paste the bot token and your own User ID into the "
                                     "/api.py data there.\n\nWhen you download and start using this bot, "
                                     "you understand and approve all the risks and download it, and you are different "
                                     "from the progress of the extent of all the risk.\n")
        ...
        elif PROMPT == "INSERT COIN LIST": pass  # TODO: INSERT COIN LIST
        elif PROMPT == "DROP COIN LIST": pass  # TODO: DROP COIN LIST
        ...
        elif PROMPT == "GET WALLET": pass  # TODO: GET WALLET
        ...
        elif PROMPT == "261021": MESSAGE.SEND("It's a beautiful day for love")
